          ...
          <div className="space-y-3.5 text-sm">
            ...
            <div className="flex justify-between border-b border-white/[0.06] py-1">
              ...
              <span className="font-mono text-xs text-slate-300">
                {escrow.buyer_wallet_id?.slice(0, 12)}...
              </span>
            </div>
            <div className="flex justify-between border-b border-white/[0.06] py-1">
              <span className="text-slate-400">Ví người bán:</span>
              <span className="font-mono text-xs text-slate-300">
                {escrow.seller_wallet_id?.slice(0, 12)}...
              </span>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="flex flex-col items-center">
                  <div className="flex size-6 items-center justify-center rounded-full border border-blue-500/30 bg-blue-500/10 text-xs font-bold text-blue-400">
                    1
                  </div>
                  <div className="h-8 w-0.5 bg-white/[0.06]" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-200">
                    Người mua thanh toán tiền ký quỹ
                  </h4>
                  <p className="mt-0.5 text-[11px] text-slate-500">
                    Tiền được khóa an toàn vào hệ thống Escrow.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="flex flex-col items-center">
                  <div className="flex size-6 items-center justify-center rounded-full border border-amber-500/30 bg-amber-500/10 text-xs font-bold text-amber-400">
                    2
                  </div>
                  <div className="h-8 w-0.5 bg-white/[0.06]" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-amber-400">
                    Tranh chấp phát sinh (Disputed)
                  </h4>
                  <p className="mt-0.5 text-[11px] text-slate-500">
                    Hệ thống ghi nhận yêu cầu hỗ trợ tranh chấp từ người dùng.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="flex flex-col items-center">
                  <div className="flex size-6 items-center justify-center rounded-full border border-white/[0.1] bg-white/[0.04] text-xs font-bold text-slate-400">
                    3
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-400">
                    Chờ Admin ra quyết định phán xử
                  </h4>
                  <p className="mt-0.5 text-[11px] text-slate-500">
                    Admin sẽ duyệt hoàn tiền cho Người mua hoặc giải ngân cho
                    Người bán.
                  </p>
                </div>
              </div>
