...
export const EscrowReadSchema = {
    ...
    type: 'object',
    required: ['id', 'order_id', 'amount', 'status', 'buyer_wallet_id', 'seller_wallet_id', 'dispute_reason', 'dispute_opened_at', 'admin_resolved_by', 'funded_at', 'release_requested_at', 'released_at', 'created_at', 'updated_at'],
    title: 'EscrowRead',
